...
*[It looks like Mom has something to say...]  ->DanasMomCorrectsDana 
...
*[Dana introduces herself.] -> DanaIntroductiontoKimmysMom
=DanaIntroductiontoKimmysMom
...
*[Kimmy looks confused.] ->KimmyHasSomethingToSay
...
*[It's the next day. You see Kimmy tied to the porch.] -> MorningKimmy
=MorningKimmy
...
*[Ask about her friends?] -> TryOne
=TryOne
Dana: That’s ok, do you have a friend you’d like to visit?
Kimmy: No...

*[Ask if she wants to do something at home?] -> TryTwo
=TryTwo
...
*[Ask if she wants to go play with the neighborhood kids?] -> TryThree
=TryThree
...
+[Tell Dean what you're saving up for!] -> Explain
=Explain
...
+[Ask Dean what he spent his money on?] -> AskDean
=AskDean
...
+[Suggest that Dean sells his clothes!] -> Suggest
=Suggest
...
+[You don't have any games!] -> NoGames
+[Map] -> WhereToGoNext
...
+[Ask if they know each other?] -> AskHarold
=AskHarold
...
Harold: Thanks...
+[Ask Harold to play a game with you?] -> PlayHarold
=PlayHarold
...
+[Ask where to find Janey at the movies] -> AskJaney
=AskJaney
...
+[Tell Janey about your babysitting job!] -> Brag
=Brag
...
+[This summer I won't be lazy.] -> NotLazy
=NotLazy
Dana: I’m glad I won’t be lazy this summer. I think I’m getting too old to be lazy. I mean, I’m going into the 5th grade.
Janey: Yeah, it’s more fun to be out with people who aren’t just teachers and classmates too. By the way, I’m not working today. Wanna play together?
+[You don't have any games!] -> NoGames
+[Map] -> WhereToGoNext
...
+[Ask about Jimmy's book] -> JimmyReads
=JimmyReads
...
+[Thinks to herself "You can do it Jimmy!"] ->BelieveInJimmy
=BelieveInJimmy
...
+[Ask Jimmy to play a game!] ->AskJimmytoPLay
=AskJimmytoPLay
...
+[Talk about the time you went to Boston] -> MyTriptoBoston
=MyTriptoBoston
...
Kimmy: I love dogs.
+[Ask Linda if she would like to play a game!] -> PlayWithLinda
=PlayWithLinda
...
===WhereToGoNext===
So Kimmy, where would you like to go now? 
    + [Downtown] -> Downtown
    + [Home] ->  Home
